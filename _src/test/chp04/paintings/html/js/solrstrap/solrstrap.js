...
var HITTITLE = 'title';
//Name of the body field- the teaser text of each hit
  ...
  (function( $ ){
    ...
    $.fn.getSolrResults = function(q, fq, offset) {
	  ...
	  function(result){
		...
		// Single HIT (document) data
		var doc = result.response.docs[i]
		var img = doc.depiction[0].replace('wikipedia/commons/','wikipedia/en/')
			//http://upload.wikimedia.org/wikipedia/commons/a/a1/Cabaret_Scene.jpg
		var hit_data = {title: title, text: text, img: img};
