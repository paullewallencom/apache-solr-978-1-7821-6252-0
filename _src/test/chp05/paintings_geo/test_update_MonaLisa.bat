...
REM 2) add the same painting, with more fields
curl "http://localhost:8983/solr/paintings_geo/update?commit=true&wt=json" -H "Content-type:application/json' -d "
[
  {
    'uri' : '01',
...
REM find out what it is on the index
